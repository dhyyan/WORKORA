...
export class HireFreelancerUseCase implements IHireFreelancerUseCase {
    ...
    constructor(contractRepository: IContractRepository, freelancerRepository: IFreelancerRepository, bidRepository: IBidRepository, jobRepository: IJobRepository) {
