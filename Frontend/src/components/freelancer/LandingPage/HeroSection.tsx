          ...
          <div className="max-w-3xl">
            ...
            >
              <button
                ...
                className="group relative px-8 py-4 bg-workora-600 hover:bg-workora-500 text-white rounded-lg font-semibold text-lg transition-all duration-300 shadow-[0_0_20px_rgba(13,148,136,0.3)] hover:shadow-[0_0_30px_rgba(13,148,136,0.5)] flex items-center justify-center gap-2 overflow-hidden">
