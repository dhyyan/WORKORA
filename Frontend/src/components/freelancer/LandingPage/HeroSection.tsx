    ...
    <>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        <div className="max-w-3xl">
          ...
          >
            Find Work That <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-workora-300 to-workora-100">
              Matches Your Skills
            </span>
          </motion.h1>
          ...
          >
            <button className="group relative px-8 py-4 bg-workora-600 hover:bg-workora-500 text-white rounded-lg font-semibold text-lg transition-all duration-300 shadow-[0_0_20px_rgba(13,148,136,0.3)] hover:shadow-[0_0_30px_rgba(13,148,136,0.5)] flex items-center justify-center gap-2 overflow-hidden">
            ...
            <button className="px-8 py-4 bg-transparent border-2 border-white/30 hover:border-white text-white rounded-lg font-semibold text-lg transition-all duration-300 hover:bg-white/10 flex items-center justify-center gap-2">
          ...
          >
            ...
            <p>Join 10,000+ freelancers finding work daily</p>
          </motion.div>
        </div>
      </div>
    </div>
