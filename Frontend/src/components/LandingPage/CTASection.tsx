...
export function CTASection() {
  return <div className="w-full py-24 bg-gradient-to-br from-teal-500 via-teal-600 to-blue-600 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        duration: 0.8
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            scale: 0.95
          }} className="group px-8 py-4 bg-white text-teal-600 rounded-xl font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center gap-2 w-full sm:w-auto">
            ...
            scale: 0.95
          }} className="px-8 py-4 bg-white/10 backdrop-blur-sm text-white border-2 border-white rounded-xl font-semibold text-lg hover:bg-white/20 transition-all duration-300 w-full sm:w-auto">
              Explore Talent
            </motion.button>
          </div>
          {/* Stats */}
