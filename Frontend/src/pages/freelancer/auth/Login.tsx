    ...
    <div className="flex min-h-screen">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="space-y-6 max-w-xl">
          ...
          <p className="text-xl opacity-90 leading-relaxed">Manage your projects, explore new opportunities — all in one place.</p>
        </motion.div>
        <p className="text-sm opacity-80">© 2026 Workora. All rights reserved.</p>
      </motion.div>
        ...
        >
          ...
          >
            <div className="space-y-2">
              ...
              <p className="text-gray-600">Sign in to access your dashboard and projects.</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="flex justify-end">
                <Link to="/freelancer/forgotpassword" title="Forgot Password" className="text-sm text-green-600 hover:text-green-700 font-medium">
                  Forgot Password?
                </Link>
              </div>
            ...
            <p className="text-center text-gray-600">
              ...
              <Link to="/freelancer/signup" className="text-green-600 hover:text-green-700 font-semibold">Sign Up</Link>
            </p>
