        ...
        <div className="min-h-screen w-full flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 p-12 flex-col justify-between text-white">
                ...
                <div className="max-w-md">
                    <h2 className="text-4xl font-bold mb-6 leading-tight">Start Your Freelance Journey Today</h2>
                    <p className="text-lg text-white/90">Join thousands of freelancers and clients who trust Workora to connect, collaborate, and grow their businesses.</p>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-4 md:p-8 bg-gray-50">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 space-y-6">
                        <div className="mb-6">
                            <h2 className="text-3xl font-bold text-gray-900 mb-2">Create Freelancer Account</h2>
                            <p className="text-gray-600">Join Workora and start your freelance journey today.</p>
                        </div>
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <p className="text-center text-gray-600 text-sm pt-2">
                                ...
                                <Link to="/freelancer/login" className="text-green-600 font-semibold hover:text-green-700">Login</Link>
                            </p>
